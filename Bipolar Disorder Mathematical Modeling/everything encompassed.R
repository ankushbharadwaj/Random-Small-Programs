...
plot(t, eta_m_new(t), type = "l", main = "Time vs eta_m", xlab = "Time - hours", ylab = "eta_m", xlim = c(0,50), ylim =c(0,5), col = "red")
par(new=T)
plot(t, c(rep.int((m_scale/t_scale),length(t))) , col="blue", xlab = "Time - hours", ylab = "eta_m", xlim = c(0,50), ylim =c(0,5),type="l")
legend(0,5,legend=c("Time Dependent eta_m", "Constant eta_m"), col = c("red","blue"),lty=1:2,cex=.8)
